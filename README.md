...
|:---------------|:-------------|:---------------- |
| 1.0.0          | `26-05-2025` | <ul><li>Removed triple alert from VMRay IOC indicators: Previously, VMRAY submitted for each malicious files three hash values. With this change it only submit the SHA256 hash value.</li><li>Removed duplicated tag: A single tag indicating Defender-AV or Defender-EDR is now used to indicates the source of the alert (instead of two more unclear tags).</li><li>
Retry logic and default adjusted.</li></ul> |
